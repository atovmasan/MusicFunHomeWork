...
let newTask
 ...
 newTask = tasks.map((task) => {
  ...
  <div onClick={() => {alert(task.id); setSelectedId(task.id)}} style={{backgroundColor: task.priority===3? "orange": task.priority===2? "black":"none", border: task.id === selectedId? "5px solid blue":"none"}} key={task.id}>
